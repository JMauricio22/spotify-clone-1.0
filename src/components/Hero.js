...
export default React.forwardRef(({ item, beforeTitle, afterTitle }, ref) => {
  ...
  return (
    <header ref={ref} className='w-full flex-grow-0 basis-[350px] shrink-0 relative overflow-x-hidden px-4 pb-4 pt-4'>
