...
export default function Aside() {
  ...
  return (
    <aside className='grid-in-aside grid md:grid-cols-1 grid-rows-[190px_50px_1fr] bg-black text-gray-300 pt-4 text-xs md:text-sm lg:text-md font-medium'>
